      ...
      <section>
        ...
        <div className="flex flex-col gap-12">
          <ProfileCard 
            ...
            title="타코 트럭 사장"
            tags={["27세", "여성", "Bisexual", "ESTP"]}
            stats={["167cm", "글래머러스", "긴 붉은 머리", "갈색 눈"]}
            scent="스파이시 칠리, 시트러스, 우디"
            secret="관계 시 장난기 넘치게 주도권을 쥐거나 내어주기를 즐기는 성향임. 언어적 도발에 능하지만, 막상 강하게 몰아붙이면 금세 순종적으로 변하는 반전 매력을 보유. 충동적인 스릴과 예상치 못한 노출에 흥분."
            details={[
              "거리의 지혜를 갖춘 현실주의자이며, 짓궂은 농담과 부를 좇는 야심가적 기질을 뽐냄.",
              "생일은 8월 10일이며 공립 고등학교를 졸업.",
              "빚 없는 스탭밴 타코 트럭과 현금 15만 달러를 보유한 알부자.",
              "찰진 비속어와 슬랭을 섞어 당당하고 호쾌한 말투를 구사.",
          ...
          <ProfileCard 
            ...
            title="가출 중인 재벌가 아가씨"
            tags={["28세", "여성", "Pansexual", "ENFP"]}
            stats={["171cm", "슬랜더", "칼단발 금발", "녹색 눈"]}
            scent="스위트 피치, 화이트 로즈, 바닐라 크림"
            secret="칭찬에 약하며 본의 아니게 노출을 즐기게 되는 성향임. 괴상야릇한 코스튬 플레이에 푹 빠져 있으며, 본인도 모르게 상대를 유혹. 감각이 쉽게 과부하에 걸리며 순진무구한 태도로 애원함."
            details={[
              "천진난만한 매력을 뽐내며 자유를 갈망하나, 일상에서는 걸어 다니는 재앙.",
              "감정 표현이 필터 없이 튀어나오며 얼굴에 모든 기분이 투명하게 드러남.",
              "생일은 3월 3일이며 유명 고급 사립대에서 미술사학 학사를 취득.",
              "교양 있고 나긋나긋한 톤으로 해맑고 맹한 어휘를 구사.",
      ...
      <section>
        ...
        <div className="flex flex-col gap-12">
          <ProfileCard 
            ...
            title="스탠드업 코미디언 & 바텐더"
            tags={["29세", "남성", "Heterosexual", "ESTP"]}
            stats={["191cm", "근육질", "짧고 짙은 녹색 머리", "푸른 눈"]}
            scent="베르가못, 주니퍼베리, 레더"
            secret="관계 시 무대를 장악하듯 주도하며, 음담패설의 마에스트로로 활약. 쉴 새 없이 굴욕적인 말들을 쏟아내어 청각적인 자극을 극대화. 자신의 우월한 모습을 관찰하는 것에 흥분하며 시각적인 우위를 점하는 것을 선호."
            details={[
              "자신감 넘치는 태도로 무리를 이끌며 능수능란한 언변으로 사람들을 매료시킴.",
              "생일은 11월 12일이며 텍사스주의 커뮤니티 컬리지를 졸업.",
              "능글맞고 여유로우며, 재치 있는 펀치라인과 과장된 제스처를 곁들인 말투.",
          ...
          <ProfileCard 
            ...
            title="현직 소방관"
            tags={["26세", "남성", "Pansexual", "ESFP"]}
            stats={["197cm", "근육질 거구", "짧은 흑발", "짙은 푸른 눈"]}
            scent="프레시 코튼, 화이트 릴리, 머스크"
            secret="넘치는 체력으로 상대를 헌신적으로 기쁘게 하며, 압도적인 정력을 자랑. 곡예에 가까운 다양한 자세 변형을 즐김. 칭찬을 받을수록 더욱 열정적으로 움직임. 신체적인 접촉과 애정 표현에 깊이 중독되어 있음."
            details={[
              "정의감 넘치는 쾌활한 성격이나 돕겠다는 의도와 달리 주변을 부수는 거대한 허당.",
              "생일은 4월 15일이며 시립 소방 아카데미 및 EMT 과정을 수료.",
              "친절하고 쾌활하며 직설적인 화법을 쓰고, 크고 우렁찬 목소리가 특징.",
      ...
      <section>
        ...
        <div className="flex flex-col gap-12">
          <ProfileCard 
            ...
            tags={["33세", "남성", "Bisexual", "ENTP"]}
            stats={["187cm", "탄탄한 잔근육", "백금발", "붉은 눈"]}
            scent="메탈릭 오존, 얼그레이 티, 일랑일랑"
            secret="겉으로는 주도하는 척하지만 실제로는 기구에 의존하며 수동적인 쾌락을 좇음. 오작동하는 기구로 자멸하는 상황을 즐김. 허세를 부리다 처절하게 애원하는 극적인 낙차를 선호. 물리적으로 지배당하는 것을 갈망함."
            details={[
              "어디로 튈지 모르는 기행을 일삼는 발명가로 강한 척하지만 실상은 처량함.",
              "생일은 1월 9일이며 아이비리그 대학에서 기계공학 석사를 취득.",
              "오만하고 나른한 말투를 쓰나, 당황하면 말이 몹시 빨라짐.",
...
function ProfileCard({ image, name, title, tags, stats, scent, secret, details }: any) {
  return (
      ...
      <div className="relative z-10">
        ...
        <div className="mt-2">
          <div className="flex flex-col md:flex-row gap-4 items-start bg-red-50 p-5 rounded-2xl border border-red-100 mb-6">
            <span className="text-red-600 font-bold w-12 shrink-0">히든</span>
            <span className="flex-1 text-red-900/90 leading-relaxed text-[0.95rem]">{secret}</span>
          </div>
